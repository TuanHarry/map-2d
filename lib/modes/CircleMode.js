...
const { getDisplayMeasurements } = require('../utils/util.js').default;
...
function circleFromTwoVertexLineString(geojson) {
  ...
  return circle(center, radiusInKm, options);
}
...
const CircleMode = {
  ...
  clickAnywhere: function (state, e) {
    console.debug('run clickAnywhere', state)
  ...
  toDisplayFeatures: function (state, geojson, display) {
    console.debug('toDisplayFeatures', state)
    ...
    console.debug('abc', circleFeature)
